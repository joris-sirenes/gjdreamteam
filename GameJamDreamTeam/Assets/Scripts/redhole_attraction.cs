...
public class redhole_attraction : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //boule = GameObject.FindGameObjectWithTag("Boule_rouge");
    ...
    void Update()
    {
        ...
        //    {
        //        Destroy(this);
        //        Destroy(GameObject.FindGameObjectWithTag("particule_rouge"));
        //        Destroy(boule);
        //    }
        //}
        //if (repulse)
    ...
    {
        if (COL.gameObject.tag.Contains("rouge"))
        {
