...
public class orangehole_attraction : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        boule = GameObject.FindGameObjectWithTag("Boule_orange");
    ...
    void Update()
    {
        if (fill)
        {
            ...
            {
                Destroy(this);
                Destroy(GameObject.FindGameObjectWithTag("particule_orange"));
                Destroy(boule);
            }
        }
        if (repulse)
    ...
    {
        if (COL.gameObject.tag == "Boule_orange")
        {
