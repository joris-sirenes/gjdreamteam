...
public class bluehole_attraction : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        boule = GameObject.FindGameObjectWithTag("Boule_bleu");
    ...
    {       
        if (fill)
        {
            ...
            {
                Destroy(this);
                Destroy(GameObject.FindGameObjectWithTag("particule_bleu"));
                Destroy(boule);
            }
        }
        if (repulse)
    ...
    {
        if (COL.gameObject.tag == "Boule_bleu")
        {
