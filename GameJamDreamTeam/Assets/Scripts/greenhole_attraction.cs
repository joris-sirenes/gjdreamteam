...
public class greenhole_attraction : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //boule = GameObject.FindGameObjectWithTag("Boule_verte");
    ...
    void Update()
    {
        ...
        //    {
        //        Destroy(this);
        //        Destroy(GameObject.FindGameObjectWithTag("particule_verte"));
        //        Destroy(boule);
        //    }
        //}
        //if (repulse)
    ...
    {
        if (COL.gameObject.tag.Contains("vert"))
        {
            Destroy(GameObject.FindGameObjectWithTag("particule_vert"));
